...
void MoveDetectDuring(void)
{
 ...
 //not shown in tutorial, but who cares, I'm just fixing the delay in strength increase so it doesn't go on forever and updates straight away.
...
void hit(void)
{
 ...
 //add your intended hit procedure here
