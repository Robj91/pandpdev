...
//A lot of these procedures aren't used anymore - they are integrated directly into phislim.c and pulllim.c.
...
void pushCol(void)
{
 ...
 &val1 = sp_custom("hupseq", &colsprite, -1);
 &val1 -= 310;
 //store dinks position
 if (&val1 == 4)
 {
...
void Trackers(void)
{
//Create collision tracker sprites that will find hardness that the hardbox will collide with
